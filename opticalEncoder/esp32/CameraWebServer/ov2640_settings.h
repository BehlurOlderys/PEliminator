...
static const DRAM_ATTR ov2640_ratio_settings_t ratio_table[] = {
    // ox,  oy,   mx,   my
    {   700,   300, 900, 900 }, //4x3
    // 400x300:x=<150,250>, y=<0,  300>
    // ox=150*4 = 600, oy=0, mx=250*4=1000, my=4*300=1200
    // 800x600:x=<350,450>, y=<150,450>
    // ox=350*2 oy=150*2=300, mx=450*2 = 900, my=450*2=900
    // { 700, 300, 900, 900}, // <- for 800x600
    {   8,  72, 1584, 1056 }, //3x2
